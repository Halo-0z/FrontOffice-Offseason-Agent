...
- `offseason_agent` — Orchestrates the workflow: decomposes the offseason goal, calls the tools above, assembles a structured proposal, and emits it for human approval. **NOT implemented in M4-A** (deferred to M4-B).
