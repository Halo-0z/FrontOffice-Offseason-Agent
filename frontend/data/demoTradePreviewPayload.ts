/**
 * Static demo trade preview payload for the M6-D frontend.
 *
...
export const demoTradePayload: DemoTradePayload = {
  ...
  roster_impact_summary:
    "Team A (DEM-ATL) post-trade roster: 4 players, 5 position need(s), 0 position strength(s).",
  depth_chart_impact_summary:
    "Team A (DEM-ATL) post-trade depth chart: 4/5 positions with a starter.",
  cap_impact_summary:
    "Team A (DEM-ATL) post-trade total_salary: $78,000,000, cap_space: $62,000,000.",
  requires_human_approval: true,
  sample_data: true,
};
